 ...
 */
package org.opendaylight.odtn.cli.commands;
...
public class OdtnCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OdtnCliTestCommand.class);
    protected final OdtnCliCommands service;

    public OdtnCliTestCommand(final OdtnCliCommands service) {
